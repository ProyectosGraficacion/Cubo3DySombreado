...
class Light extends GLJPanel implements GLEventListener, KeyListener {
    ...
    private static String TITLE = "Iluminacion";  
    ...
    this.setSomeGrayMaterial(gl, GL.GL_FRONT);
    gl.glTranslatef(0.0f, 0.0f, 0.0f);
    glut.glutSolidSphere(0.5, 20, 20); // Cambié el tamaño y el detalle de la esfera

    // Dibuja un octaedro en lugar del cono
